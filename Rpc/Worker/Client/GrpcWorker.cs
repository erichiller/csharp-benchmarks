...
public class GrpcWorker : BackgroundService {
    ...
    public GrpcWorker( ILogger<GrpcWorker> logger, ICounterService counterService ) {
        _logger         = logger;
    ...
    public override async Task StartAsync( CancellationToken cancellationToken ) {
        ...
        // _clientStreamingCall = _counterService.AccumulateCount;
    ...
    protected override async Task ExecuteAsync( CancellationToken stoppingToken ) {
        ...
        while ( !stoppingToken.IsCancellationRequested ) {
            // await _clientStreamingCall.WriteAsync( new CounterRequest { Count = count } );
            var response = await _counterService.AccumulateCount( SendAsync(stoppingToken) //,
