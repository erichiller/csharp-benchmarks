...
internal static class SR {
    ...
    // internal static global::System.Resources.ResourceManager ResourceManager => s_resourceManager ?? ( s_resourceManager = new global::System.Resources.ResourceManager( typeof(FxResources.System.Threading.Channels.SR) ) );

    /// <summary>The channel has been closed.</summary>
    internal static string @ChannelClosedException_DefaultMessage => @"The channel has been closed.";
    /// <summary>The asynchronous operation has not completed.</summary>
    internal static string @InvalidOperation_IncompleteAsyncOperation =>  @"The asynchronous operation has not completed.";
    /// <summary>Another continuation was already registered.</summary>
    internal static string @InvalidOperation_MultipleContinuations =>  @"Another continuation was already registered.";
    /// <summary>The result of the operation was already consumed and may not be used again.</summary>
    internal static string @InvalidOperation_IncorrectToken => @"The result of the operation was already consumed and may not be used again." ;
}
