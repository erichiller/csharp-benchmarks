...
public class BroadcastQueueImmutableListWriter<TData, TResponse> : ChannelWriter<TData> {
    ...
    private new ImmutableList<( BroadcastQueueReader<TData, TResponse> reader, ChannelWriter<TData> channelWriter)> _readers = ImmutableList<(BroadcastQueueReader<TData, TResponse> reader, ChannelWriter<TData> channelWriter)>.Empty; // URGENT
...
/* ************* */
public class BroadcastQueueWithImmutableListWriter<TData, TResponse> : IBroadcastQueueController<TData, TResponse> {
